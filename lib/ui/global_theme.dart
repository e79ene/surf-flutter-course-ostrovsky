...
const tabBarUnelectedDecoration = BoxDecoration(
  color: Color(0xFFF5F5F5),
  borderRadius: BorderRadius.all(Radius.circular(20)),
);
final tabBarSelectedDecoration = tabBarUnelectedDecoration.copyWith(
  color: Color(0xFF3B3E5B),
);
const tabBarUnelectedStyle = TextStyle(
  color: Color(0xFF7C7E92),
);
final tabBarSelectedStyle = tabBarUnelectedStyle.copyWith(
  color: Colors.white,
);
